...
?>
<p class="button"><a href="<?php echo get_url('plugin/frog_tags/documentation');  ?>"><img src="<?php echo get_url('images/page.png') ?>" align="middle" alt="" /> Documentation</a></p>
<p class="button"><a href="<?php echo get_url('plugin/frog_tags/available_tags'); ?>"><img src="<?php echo get_url('images/page.png') ?>" align="middle" alt="" /> Available Frog Tags</a></p>
